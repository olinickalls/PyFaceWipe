...
# base source directory (repo root)
...
extensions = [
    Extension('pyfacewipe.surfa.image.interp', [f'src/pyfacewipe/surfa/image/interp.{ext}'], **ext_opts),
#    Extension('pyfacewipe.surfa.mesh.intersection', [f'src/pyfacewipe/surfa/mesh/intersection.{ext}'], **ext_opts),
]
...
init_file = base_dir.joinpath('src/pyfacewipe/__init__.py')
