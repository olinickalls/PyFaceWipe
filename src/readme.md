...
hospital computer environment. Although I built it with Windows in mind, it
will work just as well on MacOS and Linux.

Powered by a skullstrip with the excellent tool SynthStrip, it is fast and robust,
