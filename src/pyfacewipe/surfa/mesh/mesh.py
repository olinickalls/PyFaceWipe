...
from pyfacewipe.surfa.core.array import normalize
from pyfacewipe.surfa.mesh.cache import cached_mesh_property
from pyfacewipe.surfa.mesh.intersection import IntersectionQuery
from pyfacewipe.surfa.mesh.sphere import mesh_is_sphere
from pyfacewipe.surfa.mesh.overlay import cast_overlay
from pyfacewipe.surfa.transform import ImageGeometry
from pyfacewipe.surfa.transform import image_geometry_equal
from pyfacewipe.surfa.transform import cast_image_geometry
from pyfacewipe.surfa.transform import cast_space
...
class Mesh:
    ...
    def save(self, filename, fmt=None):
        ...
        """
        from pyfacewipe.surfa.io.mesh import save_mesh
